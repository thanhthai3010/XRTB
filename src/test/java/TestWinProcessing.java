...
public class TestWinProcessing {
	...
	s = s.replaceAll("35c22289-06e2-48e9-a0cd-94aeb79fab4",
		"ADM#ssp#1023#56425#1490316943.792#68738174.223.128.39-1490316943883-130-0-0-6808053509727162318");
	if (s.indexOf("ADM#") == -1) {
	    s = s.replaceAll("123",
		    "ADM#ssp#1023#56425#1490316943.792#68738174.223.128.39-1490316943883-130-0-0-6808053509727162318");
	}
	...
	String s = Charset.defaultCharset()
		.decode(ByteBuffer.wrap(Files.readAllBytes(Paths.get("./SampleBids/negative.txt")))).toString();
    ...
    /**
     * Test that the piggy backed pixels will turn into win notifications too. Note,
     * C1X uses piggy backed wins so we will send a pixel that way.
     * 
     * @throws Exception
     *             on network errors.
     */
