...
public class TestMimeTypes {
	...
	type = MimeTypes.determineType(
		"<!-- 320x50 --><div id='hjsdtu533'></div><script type='text/javascript'>;var ppp='819f5e9e-69ef-11e6-8b77-86f30ca893d3';var rand=Math.round(new Date().getTime());var vl1='108622_{app_id}', vl3='22';document.write('<scri'+'pt type=\"text/javascript\" src=\"http://sv.rtbcon.com/sv?vv=hjsdtu533&ppp='+ppp+'&vl1='+vl1+'&vl3='+vl3+'&rand='+rand+ '&mmt=1\"></scri'+'pt>');</script>");
	assertTrue(type.equals("text/javascript"));
