...
public class Probe {
    ...
    public static final StringBuilder DEAL_PRICE_ERROR = new StringBuilder(
	    "This creative price is 0, with no set deals\n");
    public static final StringBuilder PRIVATE_AUCTION_LIMITED = new StringBuilder(
	    "This creative price is 0, with no set deals, and this is a private auction\n");
    public static final StringBuilder NO_WINNING_DEAL_FOUND = new StringBuilder(
	    "Error in finding the winning deal in the bid request\n");
    public static final StringBuilder NO_APPLIC_DEAL = new StringBuilder(
	    "This creative price is 0, with no matching deals in the bid request, and is a private auction\n");
    ...
    public static final StringBuilder BID_CREAT_IS_NATIVE = new StringBuilder(
	    "Creative is native content, request is not\n");
    public static final StringBuilder NATIVE_LAYOUT = new StringBuilder("Native ad layouts don't match\n");
    public static final StringBuilder NATIVE_TITLE = new StringBuilder(
	    "Native ad request wants a title, creative has none\n");
    public static final StringBuilder NATIVE_TITLE_LEN = new StringBuilder("Native ad title length is too long\n");
    public static final StringBuilder NATIVE_WANTS_IMAGE = new StringBuilder(
	    "Native ad request wants an img, creative has none\n");
    ...
    public static final StringBuilder NATIVE_WANTS_VIDEO = new StringBuilder(
	    "Native ad request wants a video, creative has none\n");
    public static final StringBuilder NATIVE_AD_TOO_SHORT = new StringBuilder(
	    "Native ad video duration is < what request wants");
    public static final StringBuilder NATIVE_AD_TOO_LONG = new StringBuilder(
	    "Native ad video duration is > what request wants\n");
    public static final StringBuilder NATIVE_LINEAR_MISMATCH = new StringBuilder(
	    "Native ad video linearity doesn't match the ad\n");
    public static final StringBuilder NATIVE_AD_PROTOCOL_MISMATCH = new StringBuilder(
	    "Native ad video protocol doesn't match the ad\n");
    public static final StringBuilder NATIVE_AD_DATUM_MISMATCH = new StringBuilder("Native ad data item mismatch\n");
    public static final StringBuilder WH_INTERSTITIAL = new StringBuilder(
	    "No width or height specified and campaign is not interstitial\n");
    ...
    public static final StringBuilder VIDEO_TOO_SHORT = new StringBuilder(
	    "Video Creative min duration not long enough\n");
    ...
    /**
     * Return a List of objects that denote the exchange, bids, total, and a list of
