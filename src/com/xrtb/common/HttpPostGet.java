 ...
 * bidder. Each returns a string (or byte array) which is the response from the
 * bidder. You can also retrieve the status code of the return, as well as query
 * the response headers Note-1, the connection remains open. Note-2, it will
 * decompress gzipped data on the return.
 * 
 * @author Ben Faul
 *
 */
