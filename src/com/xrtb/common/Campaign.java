...
public class Campaign implements Comparable {
     ...
     * 
     * @param str
     *            String. The hierarchy we are looking for.
     ...
     * 
     * @param id.
     *            String - the id of this campaign.
     * @param nodes
     *            nodes. List - the list of nodes to add.
     */
     ...
     * 
     * @throws Exception
     *             if the attributes of the node could not be encoded.
     */
     ...
     * 
     * @param node.
     *            Node - the evaluation node to be added to the set.
     */
