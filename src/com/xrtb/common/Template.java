...
public class Template {
    ...
    /**
     * A method for more efficient replaceAll() in a string. This is 3 - 7x faster
     * that String.replaceAll()
     * 
     * @param str
     *            String. The string to be operated on, the source.
     * @param searchChars
     *            String. The string you are looking to replace
     * @param replaceChars
     *            String. The string you want to substitute.
