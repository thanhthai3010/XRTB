...
public class Dimension {
     ...
     * 
     * @param leftX
     *            int. The value of the left side of the x equation.
     */
     ...
     * 
     * @param leftY
     *            int. The left y value of the equation.
     */
     ...
     * 
     * @param rightX
     *            int. The value of the right hand eside of the x equation.
     */
     ...
     * 
     * @param rightY
     *            int. The right hand side of the y equation.
     */
    ...
    /**
     * Handles x in the form of leftx op x op righty. Example 100 <= x <= 400. Or x
     * is between 100 and 400, To make it x = 200 use 200 <= x >= 200
     * 
     * @param leftX
     *            int. The left hand x value
     * @param rightX
     *            int. The right y value
     * @param leftY
     *            int. The left y value.
     * @param rightY
     *            int. The value of the right y.
     */
     ...
     * 
     * @param x
     *            int. The value of x. (width dimension)
     * @param y
     *            int the value of y. (height dimension)
     * @return boolean. Returns true of the equation is true. Else, returns false.
     *         If x or y is null, it returns true.
     */
