...
/**
 * Class that determines if a request log should be released. By default, all
 * requests will be released. You can set the percentage to globally log. You
 * can however override the global request percentage by specfying the log level
 * in the creation of the endpoint.
 * 
 * @author Ben M. Faul
 *
 */
public enum ExchangeLogLevel {
     ...
     * 
     * @param exchange
     *            String. The exchange in question.
     * @param level
     *            int. The level to log at 100 means all, 50 means 50%, for example.
     */
     ...
     * 
     * @param exchange
     *            String. The exchaange in question.
