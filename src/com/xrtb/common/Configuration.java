...
public class Configuration {
    ...
    /**
     * ZEROMQ LOGGING INFO getInternalAddress
     */
     ...
     * @param shard
     *            Stromg. The shard name
     * @param port
     *            int. The port the web access listens on
     * @param sslPort
     *            int. The port the SSL listens on.
     * @throws Exception
     *             on file errors.
     */
	...
	if (r != null) {
	    ...
	    Database.getInstance(redisson);
	    logger.info("*** Aerospike connection set to: {}. port: {}. connections: {}, handlers: {}", cacheHost,
		    cachePort, maxconns, AerospikeHandler.getInstance().getCount());
     ...
     * 
     * @param address
     *            String. The address being queries/
     ...
     * 
     * @param address
     *            String. The address string to change.
     * @param varName
     *            String. The name of the environment variable, begins with $
     ...
     *            String. The name of the environment variable, begins with $
     * @param altName
     *            String. The name to use if the environment variables is not
     *            defined.
     * @return String. The address string modified.
     */
     ...
     * 
     * @param address
     *            String. The address we are looking at
     ...
     * does not delete from the database Unless it is a cache2k system.
     * 
     * @param owner
     *            String. The 'owner of the campaign - the user.
     * @param name
     ...
     * commands) this does not delete from the database unless it is a Cache2k (not
     * Aerospike) based system.
     *
     * @param owner
     *            String. The owner of the campaign, associated with a user.
     * @param name
     *            String. The id of the campaign to delete a creative from.
     * @param crid
     *            String. The creative id being deleted.
     * @throws Exception
	...
	if (list == null) {
		...
		if (c.adId.matches(name)) {
		    ...
		    addCampaign(c);
		    logger.info("Loaded  {}/{}", name + "/" + c.adId);
		}
	    }
	}
    }
