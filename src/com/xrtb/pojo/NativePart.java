...
/**
 * A class that encapsulates native content bid request. Note, this is defined
 * and filled out in the construction of the bid request, and is used to match
 * against creatives.
 * 
 * @author Ben M. Faul
 *
...
public class NativePart {
    ...
    /**
     * The layout type as specified in the bid request. -1 means the bid request
     * doesn't specify one
     */
    public int layout = -1;
