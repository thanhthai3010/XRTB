...
public class Impression {
	...
	/*
	 * Object test = null; ArrayNode n = (ArrayNode) rootNode.get("imp"); JsonNode
	 * n1 = n.get(0); ObjectNode parent = (ObjectNode) n1; parent.put("bidfloor",
	 * d);
	 * 
     ...
     * 
     * @param list
     *            List. The list of attribute names. banner.w becomes "banner", "w"
     *            for example.
