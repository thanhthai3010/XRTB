...
/**
 * A class that handles google wins (synthesized in the creative, google doesn't
 * support the nurl).
 * 
 * @author Ben M. Faul
 *
...
public class GoogleWinObject extends WinObject {
     ...
     *            String. The latitude.
     * @param lon
     *            String. The longitude.
     * @param adId
     *            String. The ad id (campaign).
     * @param crid
     ...
     * @param forward
     *            String. The forward url (raw creative).
     * @param price
     *            String. The price.
     * @param adm
     *            String. The adm field sent to google.
     */
    public GoogleWinObject(String hash, String cost, String lat, String lon, String adId, String crid, String pubId,
     ...
     *            String. The encoded crypto text
     * @param utc
     *            long. The current UTC.
    ...
    /**
     * Take the bytes from BidReqyest.encrypted)hyperlocal_set, and send them here.
     * Then you can take the cleartext and
     * 
     * @param encrypted
     * @param utc
     * @return
