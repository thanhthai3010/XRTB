...
public final class NativeFramework {
     ...
     * 
     * @param a
     *            Asset. The protobuf defined asset.
     * @param array
     *            ArrayNode. The array list to add the native asset after decoding.
     */
	...
	if (doTitle(a, node) || doImg(a, node) || doVideo(a, node) || doData(a, node))
	    return;
     ...
     * 
     * @param a
     *            Asset. Tge google defined asset.
     * @param node
     *            ObjectNode. The object that will contain this asset.
     ...
     * 
     * @param a
     *            Asset. The google defined asset.
     * @param node
     *            ObjectNode. The object that will contain this asset.
