...
public class GoogleBidResponse extends com.xrtb.pojo.BidResponse {
     ...
     * 
     * @param bytes
     *            byte[]. The protobuf bytes.
     * @throws InvalidProtocolBufferException
     *             on bad expression of a a bid request.
     */
     ...
     * 
     * @param br
     *            GoogleBidRequest. The Bid request corresponding to this response.
     * @param imp
     *            Impression. The impression belonging to this response.
     * @param multi
     *            List. The list of selected creatives that match.
     * @param xtime
     *            int. The time it took to make the request.
     * @throws Exception
     *             on Protobuf serialization errors.
     */
    public GoogleBidResponse(GoogleBidRequest br, Impression imp, List<SelectedCreative> multi, int xtime)
	    throws Exception {
	this.br = br;
	...
	for (int i = 0; i < multi.size(); i++) {
	    ...
	    bb.setExtension(AdxExt.bid,
		    BidExt.newBuilder().addAllImpressionTrackingUrl(asList(snurl.toString())).build());
     ...
     * 
     * @param br
     *            GoogleBidRequest. The bid request that belongs to this response.
     * @param imp
     *            Impression. Not used.
     * @param camp
     *            Campaign. The campaign that is responding.
     * @param creat
     *            Creative. The creative that is responding.
     * @param oidStr
     *            The request object id.
     * @param price
     *            double. The price we are bidding at.
     * @param dealId
     *            String. The deal id.
     * @param xtime
     *            int. The time it took to make the bid.
     * @throws Exception
     *             on protobuf errors.
     */
    public GoogleBidResponse(GoogleBidRequest br, Impression imp, Campaign camp, Creative creat, String oidStr,
	...
	// bb.setNurl(snurl.toString());
	bb.setExtension(AdxExt.bid, BidExt.newBuilder().addAllImpressionTrackingUrl(asList(snurl.toString())).build());
	...
	if (billingId == null) {
	    throw new Exception(x.adId + "/" + c.impid + " is missing required billing_id for Google SSP");
	}
	return billingId;
    }
