...
public class Generic extends BidRequest {
     ...
     * make sure you set the exchange before using this object. Also, the
     * usesEncodedAdm flag needs to be set to false before you create the response
     * from this object, if the SSP does not use encoded ADM fields.
     * 
     * @param in
     *            String. The JSON bid request for Generic SSP.
     * @throws Exception
     *             on JSON errors.
     */
