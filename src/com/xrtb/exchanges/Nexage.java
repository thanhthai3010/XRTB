...
/**
 * A Bid request for Nexage. Exchanges can introduce their own JSON into the bid
 * request, so all the special parsing is done in a class that extends the
 * BidRequest. All standard bid requests are handled in the BidRequest super
 * class. The exchange only handles those values specific to the exchange.
 * <p>
...
public class Nexage extends BidRequest {
    ...
    /**
     * Make a default constructor, the bidder keeps a representative class instance
     * for each exchange so it can use a Map to make new bid requests per the format
     * of the bid request.
     */
    public Nexage() {
	super();
     ...
     * 
     * @param in.
     *            String - the File name containing the data.
     ...
     * 
     * @param in.
     *            InputStream - the JSON data coming from HTTP.
     * @throws JsonProcessingException
     *             on parse errors.
     * @throws IOException
     *             on file reading errors.
     ...
     * 
     * @param in
     *            InputStream. The JSON input
     * @param e
     *            String. The exchange name
     * @throws Exception
     *             will dump the error, and set the blackist flag.
     */
    ...
    /**
     * Create a new Nexage object from this class instance. To debug, do return new
     * Nexage(in, "nexage");
     * 
     * @throws JsonProcessingException
     *             on parse errors.
