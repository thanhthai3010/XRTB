...
public class AdxWinObject extends WinObject {
    ...
    public AdxWinObject(String hash, String cost, String lat, String lon, String adId, String crid, String pubId,
	...
	// Date timestamp =
	// Decrypter.getTimeFromInitializationVector(initializationVector);
	/*
