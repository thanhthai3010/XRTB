...
/**
 * An Ad Exchange Bid Response. Used to creat the logging record and the
...
public class AdxBidResponse extends BidResponse {
	...
	internal = RealtimeBidding.BidResponse.newBuilder().setProcessingTimeMs(1).build();
    }
	...
	internal = RealtimeBidding.BidResponse.newBuilder().setProcessingTimeMs(10 + n).addAllAd(adList).build();
	this.xtime = n;
