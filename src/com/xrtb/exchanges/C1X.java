...
public class C1X extends BidRequest {
     ...
     * 
     * @param in
     *            String. The JSON bid request for Epom
     * @throws Exception
     *             on JSON errors.
     */
	...
	// C1X uses ISO2 country codes, we can't digest that with our campaign
	// processor, so we
	// will convert it for them and patch the bid request.
	// Use a cache of country codes to keep from creating a lot of objects to be
