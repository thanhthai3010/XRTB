...
/**
 * Implements the logic of the spark logging system. Subscribes to ZeroMQ,
 * writes accounting records.
 * 
 * @author Ben M. Faul
 *
 */
public abstract class AbstractSparkLogger implements Runnable {
    ...
    /**
     * A map object to handle quick lookup of channel names to the list of objects
     * for that channel
     */
