...
/**
 * A class that keeps a set of bidders in a scored sorted set. Bidders add
 * themselves to the pool with their timestamp as a score. Once every 5 seconds
 * they wake up and update their own score. Each bidder also ages the set, and
 * anyone who has a timestamp over 60 seconds old is deleted from the set. If a
 * bidder is not in the pool, it is considered down.
 * 
 * @author Ben M. Faul
 *
 */
public class NameNode implements Runnable {
    ...
    /**
     * name of the scored sorted set in REDIS. Redisson does not 'directly' support
     * this construct
     */
    ...
    String name;
    /**
     * A latch to keep parent objects from stopping this thread before the redis
     ...
     * 
     * @param host
     *            String. The host of the redis system.
     * @param port
     *            int. The port for the redis system.
     * @throws Exception
     *             on IO errors.
     */
     ...
     * 
     * @param client
     *            RedissonClient. The Aerospike redisson object.
     * @throws Exception
     ...
     * 
     * @param name
     *            String. The instance name of this node.
     * @param host
     *            String. The host address of the redis server.
     * @param port
     *            int. The port number of the redis server.
     * @throws Exception
     *             on network errors
     */
     ...
     *            String. The instance name of this node.
     * @param client
     *            RedissonClient. An aerospike redisson object.
     * @throws Exception
     *             if class fails to start.
     */
     ...
     * 
     * @param name
     *            String. The name of the bidder to remove.
     */
     ...
     * @param location
     *            String. The location of where the log originated.
     * @param msg
     ...
     * @throws Exception
     *             on Redis errors (except cast error when the key is empty)
     */
