...
/**
 * A class for executing server side javascript. Copyright c, 2015 Eeminder
...
public class NashHorn {
     ...
     * 
     * @param f
     *            File. The file containing the js code.
     * @throws Exception
     *             on IO and Javascript language errors.
     */
    public NashHorn(File f) throws Exception {
	String str = Charset.defaultCharset().decode(ByteBuffer.wrap(Files.readAllBytes(Paths.get(f.getPath()))))
		.toString();
     ...
     * 
     * @param key
     *            String. The name of tha variable.
     * @param o
     *            Object. The object of that variable.
     */
    ...
    /**
     * Pluck the code between <% and %>, execute it, then take the result and
     * replace the old text.
     * 
     * @param buf
     *            StringBuffer. The html page.
     * @return boolean. True if a tag was found, otherwise false.
     * @throws Exception
     *             on JavaScript language errors or unbalanced <% %> tags.
     */
