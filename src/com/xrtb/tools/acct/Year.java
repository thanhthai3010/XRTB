...
public class Year {
	...
	if (days == null) {
	    System.out.println("\n\nYEAR TOTALS");
	    System.out.println(
		    "Year         Requests             Bids             Wins        Bid Price        Win Price           Pixels           Clicks");
	    String result = String.format("%4d %16d %16d %16d %16.4f %16.4f %16d %16d ", year, requests, bids, wins,
		    bidP, winP, pixels, clicks);
