...
/**
 * A class to create a map to look up 2 char ISO country codes and return 3 char
 * country codes.
 * 
 * @author Ben M. Faul
 *
...
public class IsoTwo2Iso3 extends LookingGlass {
     ...
     * 
     * @param name
     *            String. The name of the map in the symbol table.
     * @param file
     ...
     * 
     * @param code
     *            String. The 2 char ISO country code.
...
class InternalIso {
     ...
     * 
     * @param tokens
     *            String[]. An array of string tokens.
     */
