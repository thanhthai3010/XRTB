...
public class ANode {
     ...
     * @param hierarchy.
     *            String - the hierarchy in the request associated with this node.
     * @param operator.
     *            int - the operator to apply to this operation.
     * @param value.
     *            Object - the constant to test the value of the hierarchy against.
     * @throws Exception
	...
	/**
	 * If its an array, conmvert to a list. Passing in arrays screws up membership
     ...
     * @param value
     *            Object. The value that the bid request specified by hierarchy will
     *            be tested against.
     * @throws Exception
     ...
     * @param shell.
     *            JJS - the encapsulated Nashhorn context to use for this operation.
     * @throws Exception
     *             if the value object is not recognized.
     */
    public ANode(String name, String heirarchy, String operator, Object value, String code, JJS shell)
	    throws Exception {
     ...
     *
     * @param value.
     *            Object. Converts the value of the bid request field (Jackson) to
     ...
     *
     * @param pos.
     *            Map - A map of the geo object in the bid request; containing keys
     *            "lat","lon","type".
     * @param qvalue.
	...
	// (�3,949.901 � 3,963.189 miles)
	// The IUGG value for the equatorial radius of the Earth is 6378.137 km (3963.19
	// mile)
