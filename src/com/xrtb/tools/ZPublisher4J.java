...
/**
 * A class to log log4j messages to memory, for use by the web api. See:
 * https://mytechattempts.wordpress.com/2011/05/10/log4j-custom-memory-appender
 * 
 * @author Ben M. Faul
 *
 */
...
public class ZPublisher4J extends AppenderSkeleton {
     ...
     * 
     * @param event
     *            LoggingEvent. The log event to format and send to the log
     *            receiver.
     */
