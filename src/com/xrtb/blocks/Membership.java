...
public class Membership extends LookingGlass {
    ...
    /**
     * Create a membership from the file provided. We expect a simple list, one
     * entry per line.
     * 
     * @param name
     *            String. The name of the Membership
     * @param file
     *            String. The filename containing the goodies.
     * @throws Exception
     *             on File I/O errors.
     */
	...
	// System.out.format("[%s] - %d - %s - %s - %s\n",Controller.sdf.format(new
	// Date()), 1, Configuration.instanceName, this.getClass().getName(),message);
    }
     ...
     * @param fileName
     *            String. The filename with data.
     * @param client
     *            AerospikeClient. Pointer to your aerospike client.
     * @throws Exception
     *             on file and aerospike errors.
     */
     ...
     * @param client
     *            AerospikeClient. The aerospike to use.
     */
     ...
     * 
     * @param key
     *            Object. The key we are looking for.
     * @return Boolean. Returns the object if the object exists in the membership,
