...
public class NavMap extends LookingGlass implements Set {
    ...
    /**
     * A navigable hashmap for handling CIDR lists and range maps made from a file.
     * 
     * @param name
    ...
    /**
     * A navigable hashmap for handling CIDR lists and range maps from an S3 object.
     * 
     * @param name
     *            String. The name of the object.
     * @param object
