...
public class LookingGlass {
     ...
     * 
     * @param name
     *            String. The symbol name this object is known by in the bidder.
     * @param file
     *            String. The filename of the csv data file.
     * @throws Exception
     *             on File I/O errors.
     */
     ...
     * 
     * @param key
     *            Object. The key to use in the lookup.
    ...
    /**
     * Read comma separated items, except, ignore all comments in double quoted
     * strings.
     * 
     * @param line
