...
public class WebCampaign {
	...
	try {
		...
		response.put("error", false);
		response.put("message", "Configuration saved in Aerospike");
	    } else if (fileName.startsWith("zookeeper")) {
    ...
    /**
     * Return a list of member bidders if using aerospike, or just this instance if
     * using only cache2k
     * 
