...
public class SetPrice extends BasicCommand {
     ...
     * 
     * @param to
     *            String. The bidder that will host this command.
     * @param owner
     *            String. The owner of the campaign.
     * @param campaign
     *            String. The campaign adid to set the price on.
     * @param creative
     *            String. The creative impid to set the price on.
     * @param price
     *            double. The new price to assign to the creative.
     */
