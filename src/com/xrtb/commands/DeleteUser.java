...
/**
 * A class that is used to encapsulate a REDIS command for adding a campaign to
 * the bidder. GSON will be used to create the structure.
 * 
 * @author Ben M. Faul
 *
 */
public class DeleteUser extends BasicCommand {
     ...
     * 
     * @param to
     *            String. The bidder it is directed to.
     * @param name
     *            String. The name of the user doing the deletion.
     * @param id
     *            String. The name/id of the user being deleted.
     */
