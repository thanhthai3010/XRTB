...
/**
 * A class that is used to encapsulate a REDIS command for adding a multiple
 * compaigns to the bidder. GSON will be used to create the structure.
 * 
 * @author Ben M. Faul
 *
 */
public class AddCampaignsList extends BasicCommand {
     ...
     * 
     * @param to
     *            String. The bidder that will execute the command.
     * @param name
     *            String. The name of the owner of the campaign.
     * @param id
     *            String id. The campaign adid to load.
     */
