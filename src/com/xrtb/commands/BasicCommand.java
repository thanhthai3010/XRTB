...
/**
 * This is the basic command and response object in POJO form of commands is
 * sent over REDIS
 * 
 * @author Ben M. Faul
 *
...
public class BasicCommand {
    ...
    /**
     * The target, if any. Corresponds to instance name. If null, all bidders
     * respond, otherwise, only those bidders matching will execute ans respond
     */
    public String target = "na";

    /**
     * Empty constructor. Sets the command from to the bidder's instance name. own
     ...
     * 
     * @param to
     *            the instance string of the sender.
     */
     ...
     * 
     * @param target
     *            String. the REGEX target for the command.
     */
