...
/**
 * A class that does specialized geo tagging. Given a GPS coordinate, returns
 * the closest US zip code.
 * 
 * @author Ben M. Faul
 *
 */
public class GeoTag {
     ...
     * 
     * @param zipState
     *            String. The path of the zip codes in state database
     * @param datafile
     *            String. The path of the zip code cestroids
     * @throws Exception
     *             on file errors
     */
     ...
     * 
     * @param path
     *            String. The path of the zip code geo codes
     * @throws Exception
     *             on file errors.
     */
     ...
     * 
     * @param path
     *            String. The path name of the zip codes in state file
     * @throws Exception
     *             on file errors
     */
    ...
    /**
     * Given a GPS coordinate, return the solutin (zipcode, state, county, and
     * city).
     * 
     * @param lat
     *            double. The GPS latitude.
     * @param lon
     *            double. The GPS longitude
     ...
     * 
     * @param lat1
     *            double. The latitiude of the first point.
     * @param long1
     *            double. The longitude of the first point.
     * @param lat2
    ...
    /**
     * Makes a string key of 2 digits accuracy. Example 74.2344 is converted to
     * '74.23'
     * 
     * @param d
     *            double. The value to turn into a key.
     * @return String. The string representation of the key value of 'd' to 2 digits
     *         (truncated).
     */
