...
public class Entity {
    ...
    /**
     * Encodes this entity into the String (builder) representation used in the ADM
     * field of the +response
     * 
     * @param index
     *            int. The index of the asset in the bid request.
     * @param type
     *            int. The type of asset
     * @return StringBuilder. Tghe string representation of the entity for use int
     *         he bid response.
     */
