...
/**
 * A class that defines the assets used in a native ad bid request and used in
 * the campaign definitions
 * 
 * @author Ben M. Faul
 *
 */
...
public class Asset {
    ...
    public Entity title;
    /**
     * A link entity means there is a call to action associated with the other
     * entity in this part
     */
    public Entity link;
    ...
    /**
     * Used to form the bid response for a native ad. Returns the String (builder)
     * representation of this asset, using the index number provided (which matches
