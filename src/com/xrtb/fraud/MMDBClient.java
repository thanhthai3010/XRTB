...
public enum MMDBClient implements FraudIF {
     ...
     * 
     * @param theList
     *            List. The list of entities to block.
     */
     ...
     * 
     * @param theList
     *            theList. The list of entries to filter out.
     */
	...
	try {
	    ...
	    // System.out.println("--- FRAUD ----->" + test + ", size = " +
	    // watchlist.size());
     ...
     * 
     * @return boolean. Returns true if you should bid even if there was I/O error
     *         on the maxmind file.
     */
