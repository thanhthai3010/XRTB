...
public interface FraudIF {
     ...
     * 
     * @param rt
     *            String, record type. Some kind of marker to use for logging,
     *            usually 'display'
     * @param ip
     ...
     * @param seller
     *            String. The seller, usually app.id or site.id.
     * @param crid
     *            String. Not used, deprecated.
     * @return FraudLog. If this returns null, this is not a bot. If it is bot,
     *         returns the log record to use.
     * @throws Exception
     */
    public FraudLog bid(String rt, String ip, String url, String ua, String seller, String crid) throws Exception;

    /**
     * If you want to bid on an error (like when the underlying service is
     * unavailable, then return true.
     * 
     * @return
     */
