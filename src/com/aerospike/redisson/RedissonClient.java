...
/**
 * A Replacement for the Redisson object. This class is a serialized (JSON)
 * interface to the Aerospike/Cache2k database.
 * 
 * @author Ben M. Faul
 *
 */
public class RedissonClient {
     ...
     * 
     * @param client
     *            AerospileClient. The global aerospike object
     */
    ...
    /**
     * Instantiate the Redisson object using the Cache2k systen (embedded cache,
     ...
     * @param map
     *            Map. The map of the User object.
     * @throws Exception
     *             on cache2k/aerospike errors
     */
     ...
     * 
     * @param name
     *            String. The name of the set of strings.
     * @param set
    ...
    /**
     * Set a key value as string with an expiration (No expiration set on cache2k,
     * it is already set
     * 
     * @param skey
     *            String. The key name.
     ...
     *            String. The value.
     * @param expire
     *            int. The number of seconds before expiring.
     * @throws Exception
     *             on aerorpike or cache errors.
     */
     ...
     * 
     * @param id
     *            String. They key to get.
     * @return Map. The map stored at 'key'
     * @throws Exception
     *             on aerospike/cache2k errors.
     */
     ...
     *            String. The key name.
     * @param m
     *            Map. The value to set.
     * @param expire
     *            int. The number of seconds before expiry.
     * @throws Exception
     *             on Cache2k or aerospike errors.
     */
     ...
     * 
     * @param id
     *            String. The key value to increment.
     ...
     * 
     * @param id
     *            String. The key to expire.
     * @param expire
     *            int. The number of seconds before expiration.
     * @throws Exception
     *             on cache2k or Aerorpike errors.
     */
     ...
     * @param m
     *            Map. The map to add to the sorted list.
     */
     ...
     * 
     * @param id
     *            String. The key of the list
     * @param name
     *            String. The name what to remove from the list.
     */
     ...
     * 
     * @param id
     *            String. The key of the list to range over.
     * @param t0
     *            double. The lower value to range over.
     * @param t1
     *            double. The upper value to range over.
     ...
     * 
     * @param id
     *            String. The list to range over.
     * @param t0
     *            double. The lower range.
     * @param t1
     *            double. The upper range.
